...
public class AntiAdvertiser extends JavaPlugin {
    ...
    private FileConfiguration tlds;
    ...
    /**
     * Loads the list of valid top level domains from the configuration file to memory.
     */
    public void loadTLDs() {
    ...
    /**
     * Gets the list of valid top level domains, separated with a vertical line (|)
